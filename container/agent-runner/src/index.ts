...
const OUTPUT_START_MARKER = '---SLIMCLAW_OUTPUT_START---';
const OUTPUT_END_MARKER = '---SLIMCLAW_OUTPUT_END---';
    ...
    options: {
      ...
      mcpServers: {
        slimclaw: {
          ...
          args: [mcpServerPath],
          env: {
            SLIMCLAW_CHAT_JID: containerInput.chatJid,
            SLIMCLAW_GROUP_FOLDER: containerInput.groupFolder,
